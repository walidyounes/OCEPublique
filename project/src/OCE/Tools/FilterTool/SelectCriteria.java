...
public class SelectCriteria implements Criteria {
    ...
    /**
     * This function is used to filter a list of infraMessages to keep only the select message
     * @param infraMessages : the list of infraMessages to filter
     * @return the filtered list containing only the select infraMessages
     */
    @Override
